(define (problem starcrfp6)
    ...
    (:init
        ...
        (EsUnidad trabajador5 VCE)
        (EsUnidad trabajador6 VCE)
        (EsUnidad trabajador7 VCE)
        (EsUnidad trabajador8 VCE)
        (EsUnidad trabajador9 VCE)
        ...
        (= (CapacidadRecursos) 100)
        ;; Recursos requeridos por las Infraestructuras
        ;; Centro de Mando -> 150 Minerales & 50 Gas
        (= (EdificioNecesitaRecursos CentroDeMando Minerales) 150)
        (= (EdificioNecesitaRecursos CentroDeMando Gas) 50)
        ;; Barracones -> 150 Minerales & 0 Gas
        (= (EdificioNecesitaRecursos Barracones Minerales) 150)
        (= (EdificioNecesitaRecursos Barracones Gas) 0)
        ;; Extractor -> 75 Minerales & 0 Gas
        (= (EdificioNecesitaRecursos Extractor Minerales) 75)
        (= (EdificioNecesitaRecursos Extractor Gas) 0)
        ;; Bahia de Ingenieria -> 125 Minerales & 0 Gas
        (= (EdificioNecesitaRecursos BahiaDeIngenieria Minerales) 125)
        (= (EdificioNecesitaRecursos BahiaDeIngenieria Gas) 0)
        ;; Deposito -> 75 Minerales & 25 Gas
        (= (EdificioNecesitaRecursos Deposito Minerales) 75)
        (= (EdificioNecesitaRecursos Deposito Gas) 25)
        ;; Recursos Necesarios para el Reclutamiento de una Unidad
        ;; VCE -> 50 Minerales & 0 Gas
        (= (UnidadNecesitaRecursos VCE Minerales) 50)
        (= (UnidadNecesitaRecursos VCE Gas) 0)
        ;; Marine -> 50 Minerales & 0 Gas
        (= (UnidadNecesitaRecursos Marine Minerales) 50)
        (= (UnidadNecesitaRecursos Marine Gas) 0)
        ;; Segador -> 50 Minerales & 50 Gas
        (= (UnidadNecesitaRecursos Segador Minerales) 50)
        (= (UnidadNecesitaRecursos Segador Gas) 50)
        ;; Recursos reclamados para realizar una Investigacion
        ;; ImpulsorSegador -> 50 Minerales & 200 Gas
        (= (InvestigacionNecesitaRecursos ImpulsorSegador Minerales) 50)
        (= (InvestigacionNecesitaRecursos ImpulsorSegador Gas) 200)
        ;; Cantidad de Recoleccion
        (= (RecolectaRecurso) 25)
        ;; Beneficio en la Capacidad al construir depositivo
        (= (AumentoCapacidad) 100)
        ;; Se empieza con 0 VCE recolectando
        (= (NumeroVCE Minerales) 0)
        (= (NumeroVCE Gas) 0)
