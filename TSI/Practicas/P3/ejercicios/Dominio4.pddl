(define (domain starcrfd4)
    ...
    (:constants 
        ; subclases de cada objeto. Se añaden nuevas unidades
    ...
    (:action Construir
      ...
      :effect
        (and
            ...
            ; El edificio está en la localizacion
            (en ?e ?l)
        )
    )
    ...
    (:action Reclutar
      ...
      :precondition
        (and
            ...
            ; La unidad no ha sido reclutada ya
            (not (Reclutada ?u))
    ...
    :effect
        (and
            ; Se crea la unidad en la localizacion l
            (en ?u ?l)
            
            ; Se recluta la unidad
            (Reclutada ?u)
        )
    )
)