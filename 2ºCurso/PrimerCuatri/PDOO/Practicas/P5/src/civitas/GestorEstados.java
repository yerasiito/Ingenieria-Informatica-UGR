/**
 * @file GestorEstados.java
 * @author Yeray Lopez Ramirez
 * @author Jaime Castillo Ucles
 * @date Diciembre de 2021
 * @brief Proporcionada por el profesorado
 */
package civitas;

/**
 * @brief Clase GestorEstados que gestiona los distintos estados proporcionados
 * por el enumerado @c EstadoJuego y las operaciones de @c OperacionJuego
 */
class GestorEstados {
