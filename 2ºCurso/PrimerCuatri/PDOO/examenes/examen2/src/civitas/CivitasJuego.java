...
public class CivitasJuego {
    ...
    private void inicializaTablero(MazoSorpresas mazo){
        ...
        tablero.añadeCasilla(new CasillaCalleSostenible("Acera del Darro", 400, 250, 200, 5));
