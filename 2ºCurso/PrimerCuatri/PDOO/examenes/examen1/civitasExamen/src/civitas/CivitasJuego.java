...
public class CivitasJuego {
    ...
    private void inicializaTablero(MazoSorpresas mazo){
        ...
        //PRIMER LATERAL
        tablero.añadeCasilla(new Casilla(TipoCasilla.ESTACION, "Estacion Numero 1", TipoEstacion.CERCANIAS));
        ...
        tablero.añadeCasilla(new Casilla(TipoCasilla.ESTACION, "Estacion Numero 2", TipoEstacion.LARGADISTANCIA));
        ...
        //SEGUNDO LATERAL
        tablero.añadeCasilla(new Casilla(TipoCasilla.ESTACION, "Estacion Numero 3", TipoEstacion.MULTIPLE));
        ...
        tablero.calcularFactoresComunicacion();
    }
