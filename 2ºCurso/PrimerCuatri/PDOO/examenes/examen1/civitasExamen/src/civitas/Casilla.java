...
public class Casilla {
    ...
    private float factorComunicacion;
    ...
    //ESTACION
    public Casilla(TipoCasilla tipo, String nombre,  TipoEstacion tipoEstacion) {
        this.nombre = nombre;
        this.tipo = tipo;
        this.estacion = new Estacion(nombre,tipoEstacion);
    }
    ...
    float getFactorComunicacion() {
        return factorComunicacion;
    }
    
    void setFactorComunicacion(float factorComunicacion) {
        this.factorComunicacion = factorComunicacion;
    }
    ...
    boolean comprar(Jugador jugador){
        ...
        if(puedeComprar){
            jugador.paga(precioCompra * (1 + factorComunicacion));
            propietario = jugador;
        }
    ...
    void recibeJugador(int iactual, ArrayList<Jugador> todos){
        switch(tipo){
            ...
            case DESCANSO:
                ...
                break;
            case ESTACION:
                recibeJugador_estacion(iactual, todos);
        }
    }
    ...
    private void recibeJugador_estacion(int iactual, ArrayList<Jugador> todos){
        informe(iactual, todos);
    }
