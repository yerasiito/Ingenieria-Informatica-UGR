...
/**
 * @file  atomic.c 
 * @brief  _Se suman los elementos de una lista. El hilo 0 imprime el resultado fuera de <tt>parallel</tt>_ 
 ...
 * El código ilustra:
 * 
 * - Directivas <tt>parallel, for, atomic</tt> 
 * 
 ...
 *  **Ejecución**
 * ~~~~~~~~~~~~~~~~~~~~~
 * atomic 8    (para 8 componentes a sumar)
 * ~~~~~~~~~~~~~~~~~~~~~
 * 
*/
