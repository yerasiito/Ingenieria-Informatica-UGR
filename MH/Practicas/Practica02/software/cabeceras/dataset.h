...
struct Ejemplo {
    ...
    void imprimirCaracteristicas(){
        std::cout << std::endl;
        for(double caracteristica : caracteristicas){
            double num = caracteristica;
            if(num == int(num))
                std::cout << caracteristica << ".0,";
            else
...
class Dataset {
    ...
    public:
        ...
        */
         ...
         * @return el ejemplo en la posicion dada
        */
        [[nodiscard]] const Ejemplo &getEjemplo(int i) const;

        [[nodiscard]] const std::vector<Ejemplo> &getEjemplos() const;

        /**
         * @brief devuelve el número de ejemplos del conjunto de datos
         * @return el numero de ejemplos
        */
        [[nodiscard]] int numEjemplos() const;
        ...
        */
        [[nodiscard]] int numEtiquetas() const;
        ...
        */
        [[nodiscard]] double getCaracteristica(int i, int j) const;
        ...
        */
        [[nodiscard]] const std::string &getEtiqueta(int i) const;
        ...
        */
        [[nodiscard]] const std::string &getLabelName(int i) const;
        ...
        */
        void insertEjemplo(const Ejemplo e);
