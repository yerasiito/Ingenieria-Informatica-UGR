...
public:
   /*//Si lo ponemos publico, debemos comprobrar si los datos proporcionados son correctos(en private se puede omitir)
    void IntercambiaComponentesDirectamente(int pos_izda, int pos_dcha){
      char intercambia;
      if(EsCorrectaPosicion(pos_izda)
         &&
         EsCorrectaPosicion(pos_dcha)){
