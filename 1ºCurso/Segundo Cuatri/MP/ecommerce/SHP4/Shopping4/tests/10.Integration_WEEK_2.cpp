...
TEST_F(_01_Basics, Integrated_30_records)  {   
    ...
    SET_TIMEOUT_S(15);
    EXPECTED_OUTPUT(
[originalES(Original read from dataset)] 30 12496342285160594010
[filteredES(Events indexed)] 30 581570612384401859
...
TEST_F(_01_Basics, Integrated_926_records)  {   
    ...
    SET_TIMEOUT_S(15);
    EXPECTED_OUTPUT(
[originalES(Original read from dataset)] 500 16446961908278278083
[filteredES(Events indexed)] 500 9669934110167754270
