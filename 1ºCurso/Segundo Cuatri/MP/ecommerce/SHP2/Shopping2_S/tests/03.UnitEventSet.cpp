...
TEST_F(_03_Advanced, EventSet_at_advanced){
    ...
    es.add(e);
    ASSERT_DEATH(last_event=es.at(10),"Assertion .* failed"); //<< "Querying an EventSet beyond its legal limits must produce an assertion and stop the program"<endl;
    ASSERT_DEATH(last_event=es.at(-1),"Assertion .* failed"); //<< "Querying an EventSet beyond its legal limits must produce an assertion and stop the program"<endl;
}*/
